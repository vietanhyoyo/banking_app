...
import 'package:banking_app/features/favorite_images/data/data_sources/local/image_service.dart';
import 'package:banking_app/features/favorite_images/data/repository/image_repository_impl.dart';
...
import 'package:banking_app/features/food/data/repository/category_repository_impl.dart';
import 'package:banking_app/features/food/data/repository/product_repository_impl.dart';
...
import 'package:banking_app/features/food/domain/usecases/get_products_by_category.dart';
...
import 'package:banking_app/features/shopping/data/data_sources/remote/dio.dart';
import 'package:banking_app/features/shopping/data/data_sources/remote/shopping_api_service.dart';
import 'package:banking_app/features/shopping/data/repository/auth_repository_impl.dart';
import 'package:banking_app/features/shopping/data/repository/cart_repository_impl.dart';
import 'package:banking_app/features/shopping/data/repository/category_repository_impl.dart'
    as shopping;
import 'package:banking_app/features/shopping/data/repository/order_repository_impl.dart';
import 'package:banking_app/features/shopping/data/repository/product_repository_impl.dart'
    as shopping;
import 'package:banking_app/features/shopping/data/repository/slider_repository_impl.dart';
...
import 'package:banking_app/features/shopping/domain/repository/category_repository.dart'
    as shopping;
import 'package:banking_app/features/shopping/domain/repository/order_repository.dart';
...
import 'package:banking_app/features/shopping/domain/usecases/get_category_list_usecase.dart'
    as shopping;
import 'package:banking_app/features/shopping/domain/usecases/get_history_list_usacase.dart';
import 'package:banking_app/features/shopping/domain/usecases/get_product_list_usecase.dart'
    as shopping;
import 'package:banking_app/features/shopping/domain/usecases/get_product_list_of_category_usecase.dart';
import 'package:banking_app/features/shopping/domain/usecases/get_sliders_usecase.dart';
import 'package:banking_app/features/shopping/domain/usecases/post_make_order_usecase.dart';
